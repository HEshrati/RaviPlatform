...
import { getEventImage, getCategoryIcon } from "@/lib/dynamic-images";
import {
  ArrowRight,
  Clock,
  MapPin,
  ...
  return (
    <div className="min-h-screen pb-28" dir="rtl">
      ...
      <div className="relative overflow-hidden" style={{ background: NAVY }}>
        <img src={getCategoryIcon(categoryId)} alt={cat.title} loading="lazy" className="absolute inset-0 w-full h-full object-cover opacity-30" />
        ...
        <div className="relative z-10 max-w-lg mx-auto px-4 pt-4 pb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-white/30 flex-shrink-0">
              <img src={getCategoryIcon(categoryId)} alt={cat.title} loading="lazy" className="w-full h-full object-cover" />
            </div>
            <div>
