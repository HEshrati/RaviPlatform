        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <button
              ...
              className="mt-6 px-6 py-3 bg-orange-500 rounded-xl font-bold text-slate-900"
            >
              ...
              {providers.map((p: any) => (
                <button
                  ...
                  className={`w-full p-4 rounded-2xl border transition-all text-right flex items-start gap-4 ${
                    selected === p.id ? "border-orange-500 bg-orange-500/10" : "border-slate-200 hover:border-orange-500/30"
                  }`}
                  style={{ background: selected === p.id ? undefined : "rgba(0,0,0,0.02)" }}
                >
                  {p.avatar_url ? (
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-slate-500 text-xs mt-1">{p.years_of_experience} سال تجربه</div>
