      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-300 text-sm lg:text-base leading-relaxed max-w-2xl">
              راوی دو دنیا برایت ساخته: یکی برای **دوستی و سرگرمی** با آدم‌های
              هم‌فرکانس، و یکی برای **آرامش و رشد** با کمک متخصص. هر کدوم رو
              خواستی انتخاب کن.
            </p>
          </div>
        </div>
          ...
          >
            <div className="p-5 lg:p-6 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h3
                  className="text-lg lg:text-xl font-black mb-0.5"
                  style={{
                    color: activeHub === "fun" ? "white" : "#0f172a",
                  }}
                >
                  سرگرمی و دورهمی
                </h3>
                ...
                >
                  ۹ نوع همنشینی برای دوستی و تفریح
                </p>
              </div>
              {activeHub === "fun" && (
                <ChevronLeft size={20} className="text-white flex-shrink-0" />
              )}
            </div>
          </button>

          <button
            onClick={() => setActiveHub("therapy")}
            className="group relative rounded-3xl overflow-hidden transition-all duration-300 text-right"
            style={
              activeHub === "therapy"
                ? {
            ...
            <div className="p-5 lg:p-6 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h3
                  className="text-lg lg:text-xl font-black mb-0.5"
                  style={{
                    color: activeHub === "therapy" ? "white" : "#0f172a",
                  }}
                >
                  دوست روانشناس من
                </h3>
        ...
        {activeHub === "fun" && (
          <FunHub
            ...
            search={search}
            setSearch={setSearch}
            countByCat={eventCountByCategory}
          />
        )}
        ...
        {categories.map((cat) => {
          ...
          return (
            ...
            >
              ...
              <h4 className="font-black text-slate-900 text-sm mb-0.5 group-hover:text-orange-600 transition-colors">
                {cat.title}
              </h4>
...
function EventCard({ ev }: { ev: ApiEvent }) {
  ...
  return (
    ...
    >
      <h4 className="font-black text-slate-900 text-sm mb-2 line-clamp-2 group-hover:text-orange-600 transition-colors">
        {ev.title}
      </h4>
      ...
      <div className="flex items-center justify-between">
        <span className="text-[11px] font-bold text-slate-700">
          {ev.price?.toLocaleString()} تومان
        </span>
        <span
          className="text-[10px] font-black px-2 py-0.5 rounded-full"
          style={{
            background: full ? "rgba(148,163,184,0.15)" : "rgba(34,197,94,0.1)",
            color: full ? "#64748b" : "#16a34a",
          }}
        >
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-base font-black text-slate-900">
          نوع جلسه‌ای که می‌خوای رو انتخاب کن
        </h3>
      </div>
          ...
          >
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className="w-24 h-24 rounded-3xl flex items-center justify-center text-5xl backdrop-blur-md"
                  style={{
            ...
            <div className="p-5">
              <h4 className="font-black text-slate-900 text-lg mb-1 group-hover:opacity-80 transition-opacity">
                {opt.title}
              </h4>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: `0 4px 16px ${opt.badgeColor}40`,
                }}
              >
                مشاهده {opt.title}
              </div>
      ...
      >
        ...
        <div>
          <p className="font-black text-slate-800 text-sm mb-0.5">
            محرمانگی کامل تضمین می‌شود
          </p>
          <p className="text-xs text-slate-600 leading-relaxed">
            تمام جلسات تحت اصول اخلاق حرفه‌ای روانشناسی برگزار می‌شود. هیچ
            اطلاعاتی از جلسه شما حتی با تیم راوی به اشتراک گذاشته نمی‌شود.
          </p>
        </div>
      </div>
    </div>
