  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto mt-12 md:mt-20">
        <div className="max-w-4xl mx-auto bg-[#1a2332] backdrop-blur-sm rounded-[24px] md:rounded-[32px] p-6 md:p-8 shadow-xl shadow-slate-900/30 border border-slate-700/50">
          <div className="text-center mb-6 md:mb-8">
            <span className="text-orange-400 font-bold text-xs md:text-sm tracking-widest uppercase bg-orange-500/10 border border-orange-500/30 px-3 py-1 rounded-full inline-block">
              رویداد بعدی
            </span>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-black text-white mt-3">
